...
def test_teardown(sut: TangoSUTDeployment) -> None:
    ...
    assert obs1 != ObsState.EMPTY, "TMC Subarray observation state is EMPTY"
    assert obs2 != ObsState.EMPTY, "CSP-LMC Subarray observation state is EMPTY"
    assert obs3 != ObsState.EMPTY, "CBF Subarray observation state is EMPTY"
    assert obs4 != ObsState.EMPTY, "SDP Subarray observation state is EMPTY"
