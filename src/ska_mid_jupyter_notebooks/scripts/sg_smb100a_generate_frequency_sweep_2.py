...
RECDUR = 5  # Time in seconds to find max hold peaks
...
class SG_SOCK(socket.socket):
    ...
    def connectSG(self, sg_address):
        ...
        This function:
            - Establishes a socket connection to the Signal Generator.
            - Uses address (Including Port Number) as an argument.
    ...
    def getSGCmd(self, request_str, response_buffer=DEFAULT_BUFFER, timeout_max=10, param=""):
        ...
        while True:
            ...
            try:
                ...
                # Test to see if end of line has been reached, i.e. all data Rx
