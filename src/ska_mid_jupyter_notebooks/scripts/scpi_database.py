...
SACmds = {
    ...
    # Amplitude Commands
    "ref_level": "DISP:WIND:TRAC:Y:SCAL:RLEV",  # pass ref level e.g. DISP:WIND:TRAC:Y:SCAL:RLEV -30
    # Power Commands
    ...
    "max_hold_state": "MAXH:STAT",  # pass max hold state parameter e.g. MAXH:STAT ON
    "scale_per_div": "DISP:WIND:TRACE:Y:PDIV",  # scale/div parameter e.g. DISP:WIND:TRACE:Y:PDIV 5
    # Detector commands
